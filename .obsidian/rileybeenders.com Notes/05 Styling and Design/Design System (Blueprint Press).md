...
Its six named rules, for quick reference:
...
- **The Hard-Copy Rule** — `GanttChart.tsx`, `apple-icon.tsx`, and `opengraph-image.tsx` carry literal copies of the active preset; a palette change must reach them by hand.
