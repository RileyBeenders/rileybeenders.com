...
- `motion-fluidity` (`.agents/skills/motion-fluidity/SKILL.md`) — implementation grammar and recipes.
- `motion-layout` (`.agents/skills/motion-layout/SKILL.md`) — nav, hero, grid, and card composition patterns.
- `design-guidelines` (`.agents/skills/design-guidelines/SKILL.md`) — the Tesla/Bugatti reference tokens; the live tokens are the repo-root `DESIGN.md`.
...
- `vault-sync` (`.agents/skills/vault-sync/SKILL.md`) — required after any change under `components/` or `app/`.
