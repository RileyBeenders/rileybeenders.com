...
- `motion-design` (`.agents/skills/motion-design/SKILL.md`) — thresholds and the catalog.
- `motion-fluidity` (`.agents/skills/motion-fluidity/SKILL.md`) — the element-level recipes referenced above.
- `design-guidelines` (`.agents/skills/design-guidelines/SKILL.md`) — tokens for any new surface.
